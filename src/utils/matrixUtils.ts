...
export const ARCANA_GUIDE: Record<number, ArcanaGuide> = {
  1: { keywords: "Manifestacja, Inicjatywa, Twórczość", advice: "Twoje słowo ma moc. Zacznij to, co planowałeś." },
  2: { keywords: "Intuicja, Tajemnica, Równowaga", advice: "Słuchaj swojego wewnętrznego głosu, nie spiesz się." },
  3: { keywords: "Obfitość, Kobiecość, Płodność", advice: "Otaczaj się pięknem i dbaj o swój komfort." },
  4: { keywords: "Struktura, Władza, Stabilność", advice: "Wprowadź porządek w swoich sprawach i działaj logicznie." },
  5: { keywords: "Nauczyciel, Zasady, Tradycja", advice: "Dziel się wiedzą, ale bądź otwarty na nowe perspektywy." },
  6: { keywords: "Wybór, Miłość, Relacje", advice: "Podejmuj decyzje sercem, a nie tylko rozumem." },
  7: { keywords: "Zwycięstwo, Ruch, Ambicja", advice: "Wyznacz jasny cel i nie zatrzymuj się w połowie drogi." },
  8: { keywords: "Balans, Przyczyna i Skutek", advice: "Twoje działania wrócą do Ciebie. Bądź uczciwy." },
  9: { keywords: "Mądrość, Samotność, Wiedza", advice: "Poświęć czas na refleksję. Odpowiedzi są wewnątrz." },
  10: { keywords: "Los, Szczęście, Cykle", advice: "Zaufaj biegowi zdarzeń. Jesteś w dobrym nurcie." },
  11: { keywords: "Energia, Pasja, Potencjał", advice: "Wykorzystaj swoją siłę do tworzenia, nie do walki." },
  12: { keywords: "Perspektywa, Poświęcenie", advice: "Spójrz na sytuację pod innym kątem. Czas na pauzę." },
  13: { keywords: "Transformacja, Zmiana", advice: "Puść to, co stare, aby narodziło się coś nowego." },
  14: { keywords: "Harmonia, Cierpliwość", advice: "Znajdź złoty środek. Małe kroki prowadzą daleko." },
  15: { keywords: "Charyzma, Pokusa, Materia", advice: "Zrozum swoje cienie, a staną się Twoją siłą." },
  16: { keywords: "Przełom, Oczyszczenie", advice: "Nie bój się zmian konstrukcji. Buduj na nowym fundamencie." },
  17: { keywords: "Inspiracja, Nadzieja, Talent", advice: "Świeć jasno. Twoje marzenia są na wyciągnięcie ręki." },
  18: { keywords: "Wyobraźnia, Lęki, Podświadomość", advice: "Przekuj lęki w twórczość. Kreujesz swoją rzeczywistość." },
  19: { keywords: "Radość, Sukces, Jasność", advice: "Ciesz się życiem i dziel się swoim światłem z innymi." },
  20: { keywords: "Odrodzenie, Rodzina, Misja", advice: "Wyciągnij wnioski z przeszłości. Jesteś gotowy na etap 2.0." },
  21: { keywords: "Wolność, Granice, Globalność", advice: "Świat stoi przed Tobą otworem. Myśl szeroko." },
  22: { keywords: "Nowy początek, Lekkość", advice: "Zacznij z czystą kartą. Bądź odważny i ufny." },
};
